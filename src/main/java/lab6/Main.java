...
public class Main {
    ...
    private static final int SIZE = 60_000_000;
    private static final int HALF_SIZE = SIZE / 3;
    ...
    public static void runOneThread() {
        ...
        System.out.printf("Первый метод заканчивается : %d мс.", System.currentTimeMillis() - a);
        System.out.printf("%nПоследнее значение массива первого метода : %f \n", array[array.length - 1]);
    }
    ...
    public static void runTwoThread() {
        ...
        System.out.printf("Второй метод заканчивается через : %d мс.", System.currentTimeMillis() - a);
        System.out.printf("%nПоследнее значение массива второго метода : %f ", array[array.length - 1]);
    }
}